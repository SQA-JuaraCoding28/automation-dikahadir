...
import com.kelompok1.cucumber.utils.ScreenshotUtil;
...
public class Hooks {
    ...
    public void tearDown(Scenario scenario) {
        ...
        // Capture date-based screenshot for file history
        try {
            ScreenshotUtil.takeScreenshot(DriverManager.getDriver(), scenario.getName(), status);
        } catch (Exception e) {
            logger.error("Failed to write date-based screenshot to file: {}", e.getMessage());
        }
